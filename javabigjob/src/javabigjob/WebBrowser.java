...
public class WebBrowser extends JFrame implements HyperlinkListener,ActionListener{ 
    ...
    //建立工具栏用来显示地址栏
    JToolBar bar=new JToolBar (); //包着Box的工具栏
    
    //建立网页显示界面
    JTextField jurl = new JTextField ("www.baidu.com",60); //地址栏
    JEditorPane jEditorPane1 = new JEditorPane ();//网页界面
    JScrollPane scrollPane = new JScrollPane (jEditorPane1); 
    
    JFileChooser chooser=new JFileChooser (); 
    JFileChooser chooser1=new JFileChooser (); 
    String htmlSource; 
    JWindow window = new JWindow (WebBrowser.this); //没有这个不能全屏
    ...
    Box adress=Box.createHorizontalBox ();    //包含着地址栏的Box
